...
Procedures.fechasDisponibles = async  ( req, res)=>{
	...
	// console.log( "*****************", params );
	resultado = await Tblcobrar.find({ where:{ usu_clave_int: params.user, cob_estado: 0 } });
	// console.log("++++++++++++++++", resultado)
	if(Object.keys(resultado).length > 0) return res.ok({status:200, data: false, mensaje: "Tienes un retiro en estado pendiente mas informacion al servicio al cliente +573148487506"});
